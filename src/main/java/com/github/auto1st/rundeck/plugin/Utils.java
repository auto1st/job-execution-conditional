...
public final class Utils {
  ...
  /**
   * Plugin properties loaded from /resource/plugin.properties
   */
  ...
  /**
   * Extract the pairs from <code>-VAR=${option.VAR3}</code>, where
   * <code>"VAR"</code> is the key and <code>"${option.VAR3}"</code> is the
   * value
   * 
   * @param value
   *          The text with one or more pairs
  ...
  /**
   * Extract the pairs from <code>-VAR0 value -VAR1 value</code>, where
   * <code>"VAR0"</code> is the key and <code>"value"</code> is the value.
   * 
   * @param text
   *          The text with one or more pairs
   * @return <code>java.util.Map</code>
  ...
  /**
   * Expand the expression equals this <code>${option.VAR3}</code>, getting the
   * value from data context.<br/>
   * 
   * @param expr
   *          Expression
   * @param dataContext
   *          Rundeck data context
